...
def main():
    ...
    waypoints = generate_sine_wave_path()
    ...
    plt.plot([waypoint[0] for waypoint in waypoints], [waypoint[1] for waypoint in waypoints], 'x--', label='Desired Path')
    plt.legend()
    plt.pause(0.1)
